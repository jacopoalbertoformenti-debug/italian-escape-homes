...
const IEH_TRANSLATIONS = {
  ...
  it: {
    ...
    "common.view_on_maps"    : "Vedi su Google Maps",
    ...
    "dvv.hl.rooms.lbl"       : "Camera, castello e divano",
    ...
    "dvv.desc.p1"            : "Cercate un <strong>appartamento in Valmalenco</strong> per la vostra vacanza in montagna? <strong>Dolce Vetta Valmalenco</strong> è un nuovissimo appartamento di charme nel centro di <strong>Chiesa in Valmalenco</strong>, ai piedi del massiccio del Bernina, nel cuore delle Alpi Retiche. Recentemente ristrutturato, accoglie fino a 6 ospiti tra camera matrimoniale con letto a castello, divano letto in soggiorno e ogni comfort moderno.",
    ...
    "dvv.desc.p3"            : "All'interno trovate un ampio soggiorno con caminetto decorativo, zona pranzo, smart TV e divano letto matrimoniale; una camera matrimoniale luminosa con letto a castello e armadio; un bagno moderno con doccia; cucina completamente attrezzata; lavatrice; riscaldamento autonomo e <strong>terrazzo privato</strong> con vista sulle montagne. Il <strong>box auto privato</strong> e il parcheggio gratuito sono inclusi nel soggiorno.",
    ...
    /* ── Dolce Vetta – Camere ── */
    "dvv.room1.title"        : "Camera matrimoniale con castello",
    "dvv.room1.text"         : "Camera luminosa con letto matrimoniale, testiera in legno e letto a castello: dorme fino a 4 persone. Armadio capiente e ampio armadio a specchio, in un'atmosfera di montagna calda e accogliente.",
    "dvv.room1.d1"           : "🛏 Letto matrimoniale",
    "dvv.room1.d2"           : "🛏 Letto a castello",
    "dvv.room1.d3"           : "🌲 Stile alpino",
    "dvv.room2.title"        : "Soggiorno con divano letto",
    "dvv.room2.text"         : "Ampio soggiorno con divano letto matrimoniale, cuscini d'arredo e lampada da terra, caminetto decorativo, smart TV, zona pranzo e accesso al terrazzo privato. Perfetto per ospitare fino a 2 persone aggiuntive.",
    ...
    "dvv.faq.a2"             : "Fino a 6 ospiti: una camera matrimoniale con letto a castello e un divano letto matrimoniale in soggiorno.",
  ...
  en: {
    ...
    "common.view_on_maps"    : "View on Google Maps",
    ...
    /* ── Dolce Vetta Valmalenco – Meta ── */
    "dvv.meta.title"         : "Dolce Vetta Valmalenco – Apartment in the centre of Chiesa in Valmalenco, sleeps 6",
    "dvv.meta.desc"          : "Charming apartment in the centre of Chiesa in Valmalenco, at the foot of the Bernina massif. 1 bedroom with bunk bed + sofa bed, 6 guests, private terrace, garage and parking. Steps from the Snow Eagle cable car.",
    ...
    "dvv.hl.rooms.lbl"       : "Bedroom, bunk & sofa bed",
    ...
    "dvv.desc.p1"            : "Looking for an <strong>apartment in Valmalenco</strong> for your mountain holiday? <strong>Dolce Vetta Valmalenco</strong> is a brand-new charming apartment in the centre of <strong>Chiesa in Valmalenco</strong>, at the foot of the Bernina massif, in the heart of the Rhaetian Alps. Recently renovated, it sleeps up to 6 guests across a double bedroom with bunk bed and a sofa bed in the living room, with every modern comfort.",
    ...
    "dvv.desc.p3"            : "Inside you'll find a spacious living room with decorative fireplace, dining area, smart TV and double sofa bed; a bright double bedroom with bunk bed and wardrobe; a modern bathroom with shower; fully equipped kitchen; washing machine; independent heating and a <strong>private terrace</strong> with mountain views. A <strong>private garage</strong> and free parking are included.",
    ...
    "dvv.room1.text"         : "Bright bedroom with double bed, wooden headboard and bunk bed: sleeps up to 4 people. Spacious wardrobe and large mirrored closet, in a warm and welcoming mountain atmosphere.",
    "dvv.room1.d1"           : "🛏 Double bed",
    "dvv.room1.d2"           : "🛏 Bunk bed",
    "dvv.room1.d3"           : "🌲 Alpine style",
    "dvv.room2.title"        : "Living room with sofa bed",
    "dvv.room2.text"         : "Spacious living room with double sofa bed, decorative cushions and floor lamp, decorative fireplace, smart TV, dining area and access to the private terrace. Perfect for hosting up to 2 additional guests.",
    ...
    "dvv.faq.a2"             : "Up to 6 guests: a double bedroom with bunk bed and a double sofa bed in the living room.",
  ...
  de: {
    ...
    "common.view_on_maps"    : "Auf Google Maps ansehen",
    ...
    /* ── Dolce Vetta Valmalenco – Meta ── */
    "dvv.meta.title"         : "Dolce Vetta Valmalenco – Wohnung im Zentrum von Chiesa in Valmalenco (SO), bis 6 Gäste",
    "dvv.meta.desc"          : "Charmante Wohnung im Zentrum von Chiesa in Valmalenco, am Fuße des Bernina-Massivs. 1 Schlafzimmer mit Etagenbett + Schlafsofa, 6 Gäste, private Terrasse, Garage und Parkplatz. Wenige Schritte zur Seilbahn Snow Eagle.",
    ...
    "dvv.hl.rooms.lbl"       : "Zimmer, Etagen- & Schlafsofa",
    ...
    "dvv.desc.p3"            : "Im Inneren erwarten Sie ein geräumiges Wohnzimmer mit Zierkamin, Essbereich, Smart-TV und Doppelschlafsofa; ein helles Doppelzimmer mit Etagenbett und Schrank; ein modernes Badezimmer mit Dusche; eine voll ausgestattete Küche; Waschmaschine; autonome Heizung und eine <strong>private Terrasse</strong> mit Bergblick. <strong>Private Garage</strong> und kostenloser Parkplatz sind inklusive.",
    ...
    "dvv.room1.text"         : "Helles Zimmer mit Doppelbett, Holzkopfteil und Etagenbett: schläft bis zu 4 Personen. Geräumiger Kleiderschrank und großer Spiegelschrank, in warmer und einladender Bergatmosphäre.",
    "dvv.room1.d1"           : "🛏 Doppelbett",
    "dvv.room1.d2"           : "🛏 Etagenbett",
    "dvv.room1.d3"           : "🌲 Alpenstil",
    "dvv.room2.title"        : "Wohnzimmer mit Schlafsofa",
    "dvv.room2.text"         : "Geräumiges Wohnzimmer mit Doppelschlafsofa, Zierkissen und Stehlampe, Zierkamin, Smart-TV, Essbereich und Zugang zur privaten Terrasse. Perfekt für bis zu 2 zusätzliche Gäste.",
    ...
    "dvv.faq.a2"             : "Bis zu 6 Gäste: ein Doppelzimmer mit Etagenbett und ein Doppelschlafsofa im Wohnzimmer.",
  ...
  fr: {
    ...
    "common.view_on_maps"    : "Voir sur Google Maps",
    ...
    /* ── Dolce Vetta Valmalenco – Meta ── */
    "dvv.meta.title"         : "Dolce Vetta Valmalenco – Appartement au centre de Chiesa in Valmalenco (SO), 6 personnes",
    "dvv.meta.desc"          : "Appartement de charme au centre de Chiesa in Valmalenco, au pied du massif de la Bernina. 1 chambre avec lits superposés + canapé-lit, 6 personnes, terrasse privée, garage et parking. À deux pas du téléphérique Snow Eagle.",
    ...
    "dvv.hl.rooms.lbl"       : "Chambre, superposés et canapé",
    ...
    "dvv.desc.p1"            : "Vous cherchez un <strong>appartement en Valmalenco</strong> pour vos vacances à la montagne ? <strong>Dolce Vetta Valmalenco</strong> est un appartement de charme tout neuf au centre de <strong>Chiesa in Valmalenco</strong>, au pied du massif de la Bernina, au cœur des Alpes rhétiques. Récemment rénové, il accueille jusqu'à 6 personnes entre une chambre double avec lits superposés et un canapé-lit dans le séjour, avec tout le confort moderne.",
    ...
    "dvv.desc.p3"            : "À l'intérieur, vous trouverez un vaste séjour avec cheminée décorative, espace repas, smart TV et canapé-lit double ; une chambre double lumineuse avec lits superposés et armoire ; une salle de bains moderne avec douche ; une cuisine entièrement équipée ; un lave-linge ; un chauffage autonome et une <strong>terrasse privée</strong> avec vue sur les montagnes. Le <strong>garage privé</strong> et le parking gratuit sont inclus.",
    ...
    "dvv.room1.text"         : "Chambre lumineuse avec lit double, tête de lit en bois et lits superposés : couche jusqu'à 4 personnes. Armoire spacieuse et grand placard à miroir, dans une ambiance montagnarde chaleureuse et accueillante.",
    "dvv.room1.d1"           : "🛏 Lit double",
    "dvv.room1.d2"           : "🛏 Lits superposés",
    "dvv.room1.d3"           : "🌲 Style alpin",
    "dvv.room2.title"        : "Séjour avec canapé-lit",
    "dvv.room2.text"         : "Vaste séjour avec canapé-lit double, coussins décoratifs et lampadaire, cheminée décorative, smart TV, espace repas et accès à la terrasse privée. Parfait pour accueillir jusqu'à 2 personnes supplémentaires.",
    ...
    "dvv.faq.a2"             : "Jusqu'à 6 personnes : une chambre double avec lits superposés et un canapé-lit double dans le séjour.",
